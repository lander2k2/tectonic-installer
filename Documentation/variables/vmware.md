...
| tectonic_vmware_master_datastores | terraform map of master node(s) vSphere Datastores, example:   tectonic_vmware_master_datastores = {   "0" = "myvmwareds-0"   "1" = "myvmwareds-1" } | map | - |
